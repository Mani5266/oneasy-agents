...
export default function ChatPanel({data,step,done,pct,sessionId,onUpdates,onStep,onDone,onRestart,onRestore,onBackToDashboard,onHistory}:Props) {
    ...
    <div className="chat-container">
      ...
      <div className="chat-header" style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 20px",background:"#0f1a2e",flexShrink:0,borderBottom:"1px solid rgba(255,255,255,0.06)"}}>
        ...
        <div style={{display:"flex",gap:6,alignItems:"center"}}>
          {onHistory && (
            <button className="chat-header-btn" onClick={onHistory} title="History">
