        ...
        <main id="mainContent" style={{ flex: 1, display: 'flex', minWidth: 0, height: '100%', overflow: 'hidden' }}>
          ...
          {currentPage === 'generator' && chatOpen && (
            <>
              ...
              />
              <div style={{ width: 340, minWidth: 280, maxWidth: 380, flexShrink: 0, height: '100%', overflow: 'hidden', borderRight: '1px solid var(--border)' }}>
                <ChatPanel
          ...
          {/* ── Form / Content area ── */}
          <div className="content" style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden', padding: 0 }}>
            {/* ── Generator View ── */}
                  ...
                  <div className="page">
                    ...
                    <div className="page-header">
                      ...
                      <button
                        ...
                        className="btn"
                        style={{ marginTop: 'var(--space-3)', padding: 'var(--space-2) var(--space-3)', fontSize: 'var(--text-xs)', fontWeight: 600, color: 'var(--accent-dark)', background: 'transparent', border: 'none', minHeight: 'auto' }}
                      >
